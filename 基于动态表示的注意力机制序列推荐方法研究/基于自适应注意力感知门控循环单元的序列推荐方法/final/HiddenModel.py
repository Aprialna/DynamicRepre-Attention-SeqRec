...
class Model(object):
    def __init__(self, batch_size, state_width, n_poi, n_user,is_training, learning_rate=0.0001, l2=1e-4):
        ...
        input_attention_output_pos = tf.reshape(history,shape=[batch_size, -1, self.state_width])
        # input_attention_output_neg = tf.reshape(input_attention_output_neg,shape=[batch_size, -1, self.state_width])
